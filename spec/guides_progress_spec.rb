...
describe Course do
  ...
  let(:guide_progress2) { {
    ...
    last_assignment: {exercise: {eid: 1}, submission: {status: :failed, created_at: '2019-01-06T18:39:57.000Z'}}
  } }
  ...
  let(:guide_progress3) { {
    ...
    last_assignment: {exercise: {eid: 1}, submission: {status: :passed_with_warnings, created_at: '2019-07-03T18:39:57.000Z'}}
  } }

  let(:assignment1) { {
    guide: { slug: 'example.org/foo' },
    student: {uid: 'agus@mumuki.org', first_name: 'foo', last_name: 'bar', email: 'agus@mumuki.org'},
    submissions: [ { status: 'passed', created_at: '2019-08-01T18:39:57.000Z'} ],
    exercise: { eid: 1}
  } }
...
bar,foo,agus@mumuki.org,2019-07-03T18:39:57.000Z,false,example.org/bar,0,1,0
doe,john,john@gmail.com,2019-01-06T18:39:57.000Z,false,example.org/foo,2,0,1
TEST
        end
    end
