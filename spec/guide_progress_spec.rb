...
describe 'Classroom::GuideProgress' do
  ...
  describe '#update!' do
    ...
    context 'when new exercise is submitted for existing guide' do
      before do
        Classroom::Collection::GuideStudentsProgress.for('foo').update! submission.merge({'id' => 'abc1235', 'exercise' => {'id' => 25, 'name' => 'Second Steps', 'number' => 8}})
      end
    ...
    context 'when new submission is submitted for existing exercise' do
      before do
        Classroom::Collection::GuideStudentsProgress.for('foo').update! submission.merge({'id' => 'abc1235'})
      end
    ...
    context 'when exercise has changed, a new submission updates it' do
      ...
      before do
        Classroom::Collection::GuideStudentsProgress.for('foo').update! submission.merge({'id' => 'abcd1235', 'exercise' => {'id' => 10, 'name' => 'New name', 'number' => 3}})
      end
